...
//                    System.out.println("what" + new_seat);
        ...
        int temp[][]= screen.getSeatingArrangement();

        if(reservation.getID().equals("R001"))
    ...
    public boolean checkAvailability(int[] row, int emptySeatIndex, int noOfPeople){
